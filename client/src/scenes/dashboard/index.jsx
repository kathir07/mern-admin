...
function Dashboard() {
  ...
  return (
    <Box m="1.5rem 2.5rem">
      ...
      <Box mt="20px" display="grid" gridTemplateColumns="repeat(12, 1fr)" gridAutoRows="160px"
        gap="20px"
       sx={{
      ...
      >
        ...
        />
         <StatBox title="Sales Today" value={data && data.todayStats.totalSales} increase="+21%" description="Since last day" 
        ...
        />
          <StatBox title="Yearly Sales" value={data && data.yearlySalesTotal} increase="+43%" description="Since last year" 
        ...
        >
          ...
          <Typography p="0 0.6rem" fontSize="0.8rem" sx={{ color: theme.palette.secondary[200]}}>
            Breakdown for real sales and information via category for revenue made for this year and total sales
          </Typography>
        </Box>
      </Box>
    </Box>
